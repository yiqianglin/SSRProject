...
export function applyAsyncData(Component, asyncData) {
  ...
  if (Component._Ctor && Component.options) {
    console.log('Component._Ctor && Component.options')
    console.log(Component._Ctor)
...
export function sanitizeComponent(Component) {
  // If Component already sanitizeComponent
